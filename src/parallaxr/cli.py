"""Command-line interface for parallaxr."""
...
@click.group()
@click.version_option(version=__version__, prog_name="parallaxr")
def cli() -> None:
    """
    Parallaxr: A command-line tool for running systematic experiments
...
Please provide a concise summary that covers the key concepts and applications."""
    ...
    context_content = """Additional context: This is a test of the parallaxr system.
...
# DEBUG=false"""
    ...
    click.echo("3. Run: parallaxr run -p prompt.txt -e experiments.csv -o results.csv")
